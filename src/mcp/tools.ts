    ...
    inputSchema: {
      ...
      properties: {
        ...
        includeGenerated: {
          type: "boolean",
          description:
            "Scan generated / vendored files too (default: false). By default protobuf output, *.generated.* files, files under a generated/ directory, and files with a @generated / DO NOT EDIT / Code generated by marker in their first ~500 bytes are skipped — their repetition isn't actionable copy-paste. Matches involving a generated file are tagged signals: ['generated'].",
        },
        package: FAN_OUT_PACKAGE_PROPERTY,
      },
      required: ["root"],
