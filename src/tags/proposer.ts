...
/**
 * Walks the incoming dependency graph from each changed file.
 *
...
/**
 * Proposes Vitest tags to run based on which files changed.
 *
...
/**
 * Returns the file paths of test files affected by the changed files.
 *
...
class TagProposalContext {
  ...
  constructor(startPath: string, exports: string[]) {
    this.affectedSymbols.set(startPath, new Set(["*", "default", ...exports]));
  }
